  ...
  return (
    <>
      ...
      <header className="py-5 bg-white">
        <div className="d-flex justify-content-between align-items-center fixed-top bg-white p-3">
          <div className="dropdown">
            <a
              href="#"
              className="col-lg-4 mb-2 mb-lg-0 link-body-emphasis text-decoration-none"
      ...
      <main className="row">
        <nav className="col-md-auto me-5">
          <div
            id="sidenav"
        ...
        <section id="content" className="col w-100">
